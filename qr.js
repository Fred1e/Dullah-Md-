		...
		try {
			...
			Qr_Code_By_Maher_Zubair.ev.on("connection.update", async (s) => {
				...
				if (connection == "open") {
				   ...
				   let SIGMA_MD_TEXT = `
*BONIPHACE MD 💥 QR CODE CONNECTED*

> You have completed the first step of Deploying *BONIPHACE_MD 💥*, Copy the above message and deploy your bot.Meanwhile you must follow the 4 steps. 
